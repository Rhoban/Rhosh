 ...
 * Example :
 *
 * TERMINAL_COMMAND(hello, "Output a friendly warming welcoming message")
 * {
 *     if (argc > 0) {
 ...
 * an initialized instance of USBInput or HardwareInput
 */
void terminal_init(Rhosh::IO *io);
...
/**
 * Returns the Output and Read instance used 
 * to write on the serial port
 */
Rhosh::IO *terminal_io();
